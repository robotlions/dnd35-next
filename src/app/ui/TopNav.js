    ...
    return links.map((link) => {
      return (
        <li key={link.linkName}>
          ...
          >
            <p className="hidden md:block font-bold text-xl mb-2 font-[family-name:var(--font-imFellSC)]">
              {link.linkName}
            </p>
          </Link>
        </li>
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="text-center">
              <>
                ...
                <p className="font-bold text-xl mb-2 font-[family-name:var(--font-imFell)]">
